...
The captures section can be left empty if the lambda does not need to access any external variables.
...
\section{Sanitizers (before compiling), compile-time, runtime).
