...
\subsection{Print a set of key, value pairs from a map}
...
\subsection{For\_Each C++03 example}

For\_each, is a well known algorithm for for loops.
\begin{verbatim}
#include <string>
...
\subsection{Implementation in c++98}

This is before Lambda support.
...
\subsection{Accumulate (Algorithms)}
